...
{\bf Here we propose to use maize adaptation (\emph{Zea mays} ssp. \emph{mays}) to high elevation environments as a model for understanding the genetic basis of local adaptation}.  Maize was domesticated in the lowlands of southwest Mexico from the narrowly distributed teosinte \emph{Zea mays} ssp. \emph{parviglumis} \citep[hereafter, \emph{parviglumis}][]{Matsuoka2002}. In contrast to its progenitor, maize is now cultivated on six continents, ranging from southern Chile to Canada \citep{tenaillon2011european} and from sea level to well over 3000m in altitude, and analysis of cultivation area data indicates that maize has the greatest global geographic breadth of 16 staple crops (Figure \ref{fig:breadth}). 

\begin{SCfigure}[][b]
  \centering
  \caption{Geographic breadth of the world's 16 most important crops. Geographic breadth is expressed in percent of land surface area in which each crop is cultiavated. Data from \citet{monfreda2008farming}. } 
   \includegraphics[width=0.5\textwidth]{breadth.png}
\label{fig:breadth}
\end{SCfigure}

Following domestication, maize spread to the highlands of the Central Plateau, a migration across more than 1000m of increasing elevation (CITE).  Maize landraces in the Central Plateau have distinct morphologies (e.g., highly pigmented and hairy leaves and stems) that are believed to confer adaptation to this cooler region (CITE).  Our previous genetic analyses \citep{vanheerwaarden2011a} show that maize has independently adapted to highland environments multiple times, including the southwest US and the Andes of South America, where  landraces (i.e., local farmer varieties) are commonly grown above 3000m.  In addition to maize colonization of highland environments, the wild progenitor of maize, \emph{parviglumis} differs from another teosinte subspecies \emph{Zea mays} ssp. \emph{mexicana} (hereafter, \emph{mexicana}) in their adaptation across a similar elevational gradient.  Together, maize and teosinte form an ideal system in which multiple replicated evolutionary experiments will allow us to dissect the genetic architecture of highland adaptation as a model for understanding plant local adaptation.
%needs cites
...
Preliminary work from project members will inform the activities proposed here.  PI Ross-Ibarra has previously explored patterns of local adaptation in \emph{parviglumis} and \emph{mexicana} populations across $>$40,000 genotyped SNPs, finding a large number of loci showing evidence of selection, with targest enriched in non-coding regions.  regulatory changes could be under selection during local adaptation \citep{Pyhajarvi2013}.  This same study also revealed that inversion polymorphisms play a substantial role in conferring adaptation across an elevational gradient \citep{Pyhajarvi2013}, and identified an inversion on chromosome four that almost perfectly distinguishes the lowland \emph{parviglumis} from the highland \emph{mexicana} and overlaps with a quantitative trait locus associated with leaf sheath pigmentation and hairs \citep{Lauter2004a}, traits linked to highland adaptation.  Subsequently, Co-PIs. Hufford and Ross-Ibarra found that the \emph{mexicana} allele of this inversion had introgressed into maize in the highlands of Mexico \citep{Hufford2013}.  Subsequent growth chamber experiments showed that introgressed plants had \emph{mexicana}-like phenotypes and superior growth, suggesting an adaptive role for  \emph{mexicana} introgression.  Current work in the Hufford and Ross-Ibarra laboratories is utilizing genotyping data to investigate parallel versus independent adaptation of maize landraces from the highlands of Mexico and the Andes.  Results suggest adaptation has largely been obtained independently in these geographic regions (Takuno et al. In Prep; Figure  \ref{fig:fst}).  Full genome resequencing underway will increase the resolution of this study and expand its scope to include maize from the highlands of Guatemala and the Southwestern United States.
