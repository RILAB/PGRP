...
Preliminary work from project members will inform the activities proposed here.  The Ross-Ibarra Lab has previously explored patterns of local adaptation in \emph{parviglumis} and \emph{mexicana} populations across $>$40,000 genotyped SNPs, finding non-coding loci to be enriched in candidates, a result that suggests regulatory changes could be under selection during local adaptation (Pyh�j�rvi et al. 2013).  This same study also revealed that inversion polymorphisms play a substantial role in conferring adaptation across an elevational gradient (Pyh�j�rvi et al. 2013).  An inversion on chromosome four was shown to almost perfectly distinguished \emph{parviglumis} from \emph{mexicana}.  Subsequently, Drs. Hufford and Ross-Ibarra found that the \emph{mexicana} type of this inversion had introgressed into sympatric maize in the highlands of Mexico (Hufford et al. 2013).  This region on chromosome four overlaps with a quantitative trait locus associated with leaf and sheath pigmentation and hairs (Lauter et al. 2004), traits linked to highland adaptation, and may have introgressed due to selection for local adaptation.  In a growth chamber experiment simulating the cool temperatures typical of the Mexican highlands, maize plants with the \emph{mexicana} inversion type were darkly pigmented, hairy and showed robust growth whereas maize without this inversion type were green, glabrous, and stunted (Hufford et al. 2013).  Current work in the Hufford and Ross-Ibarra laboratories is utilizing genotyping data to investigate parallel versus independent adaptation of maize landraces from the highlands of Mexico and the Andes.  Results suggest adaptation has largely been obtained independently in these geographic regions (Takuno et al. In Prep; Figure X).  Full genome resequencing underway will increase the resolution of this study and expand its scope to include maize from the highlands of Guatemala and the Southwestern United States.
