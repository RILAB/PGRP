...
While mexicana and parviglumis are largely allopatric in their distributions, the subspecies overlap in two regions of Mexico, eastern Jalisco state and the eastern Balsas River Basin.  A number of mexicana-parviglumis hybrid populations have been documented in these regions (CITE Fukunaga et al. 2005).  In our previous work (CITE Pyh�j�rvi et al. 2013) we have genotyped twelve individuals from one such hybrid population located near the town of Ahuacatitlan, Mexico in the eastern Balsas.  Genome-wide, each individual was estimated to have $\sim$50\% ancestry from mexicana and $\sim$50\% ancestry from parviglumis.  A relatively short length of shared haplotypes between Ahuacatitlan and other teosinte populations suggested that hybridization was not extremely recent.  The high number of crossovers between mexicana and parviglumis in chromosomes from this population make Ahuacatitlan an ideal resource for admixture mapping of mexicana highland adaptation traits.
