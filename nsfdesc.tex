...
While \emph{mexicana} and \emph{parviglumis} are largely allopatric in their distributions, the subspecies overlap in two regions of Mexico, eastern Jalisco state and the eastern Balsas River Basin.  A number of \emph{mexicana-parviglumis} hybrid populations have been documented in these regions (CITE Fukunaga et al. 2005).  In our previous work (CITE Pyh�j�rvi et al. 2013) we have genotyped twelve individuals from one such hybrid population located near the town of Ahuacatitlan, Mexico in the eastern Balsas.  Genome-wide, each individual was estimated to have $\sim$50\% ancestry from \emph{mexicana} and $\sim$50\% ancestry from \emph{parviglumis}.  A relatively short length of shared haplotypes between Ahuacatitlan and other teosinte populations suggested that hybridization was not extremely recent.  The high number of crossovers between \emph{mexicana} and \emph{parviglumis} in chromosomes from this population make Ahuacatitlan an ideal resource for admixture mapping of \emph{mexicana} highland adaptation traits.

Small collections of seed from Ahuacatitlan are available in public repositories, but, for large-scale admixture mapping, additional collections will be required.  In November of year one of the project we will travel to Ahuacatitlan and collect seed from 500 individuals drawn randomly from the population.  Seed samples will be transported to Langebio in Irapuato, Mexico for cold storage. A single seed per individual (500 total) will be germinated on filter paper and transplanted into our two Mexican field sites (Table 2).  The Columbia, Missouri field site will not be used for this portion of the project because teosinte is day-length sensitive and will not flower at high latitudes.  Phenotypes from Aim 1.1 (Figure 3) will also be collected from Ahuacatitlan teosinte for admixture mapping.  The majority of these traits are known to differ considerably between \emph{parviglumis} and \emph{mexicana} (CITE).
